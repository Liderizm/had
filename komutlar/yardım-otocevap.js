...
.setColor('#ffffff') 
.setAuthor(`VR-AT Oto Cevap Komutları`, client.user.avatarURL())
.setDescription(`<a:VR-AT:749380925619437619> VR-AT botumuzu eklemek için \`${prefix}davet\` yazabilirsiniz.`)
