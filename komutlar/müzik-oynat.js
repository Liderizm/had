...
const sarki = await client.player.play(message.member.voice.channel, args.join(" "));
  ...
  .setColor(AloneDogru)
  .setTitle("VR-AT | Oynatılan Şarkı")
...
sarki.queue.on('end', () => {
  ...
  .setColor(AloneDogru)
  .setTitle("VR-AT | Kuyruk Bitti!")
  .setDescription(`<:a_:821738957997211659>  **| Kuyruktaki tüm müzikler oynatıldı. VR-AT kanaldan ayrılıyor.\n\nVR-AT Tercih ettiğiniz için teşekkür ederiz.**`)
  .setThumbnail(client.user.avatarURL())
.setFooter(`©️ Tüm hakları saklıdır | Yeni Nesil Gelişmiş Bot | 2020`, client.user.avatarURL());  
