...
.setColor('#ffffff') 
.setAuthor(`VR-AT Moderasyon Komutları`, client.user.avatarURL())
.setDescription(`<:a_:821738957997211659>  VR-AT botumuzu eklemek için \`${prefix}davet\` yazabilirsiniz.`)
